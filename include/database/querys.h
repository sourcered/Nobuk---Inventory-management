...
const std::string SQL_CREATE_TABLE =    "CREATE TABLE IF NOT EXISTS " + TABLE_NAME + " (id INT NOT NULL PRIMARY KEY AUTO_INCREMENT, code INT NOT NULL UNIQUE, name VARCHAR(60) NOT NULL DEFAULT \'No name\', quantity FLOAT NOT NULL DEFAULT 0, price FLOAT NOT NULL DEFAULT 0, total FLOAT NOT NULL DEFAULT 0)";
