...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        actionTotal = new QAction(MainWindow);
        actionTotal->setObjectName(QStringLiteral("actionTotal"));
        actionTotal->setIcon(icon3);
        ...
        menuItem->addSeparator();
        menuItem->addAction(actionTotal);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        actionTotal->setText(QApplication::translate("MainWindow", "Total", 0));
